...
public class MySectionAudio extends StatelessSection {

    private String index;
    private int sameDuplicateSize;
    private DuplicateAudio context;
    private DuplicateFileRemover activity;
    private int unCheckedCount = 1;

    private ArrayList<ModelClass> modelList = new ArrayList<>();

    MySectionAudio(DuplicateFileRemover activity, DuplicateAudio context, String index, HashMap<File, String> list) {
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        itemHolder.thumbnail.setImageResource(R.drawable.audio_file);
        ...
        itemHolder.checkBox.setOnClickListener(view -> {
            ...
            if (modelList.get(position).getSelected()) {
                ...
                if (unCheckedCount == 1) {
                    ...
                    Constant.toastShort(activity, "Can't select all audio of same group");
                } else {
                    unCheckedCount--;
    ...
    public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder) {
        ...
        String title = "Group " + index + ": " + sameDuplicateSize + " duplicate audio";
